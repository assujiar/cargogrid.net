  ...
  blocks: [
    ...
    },
    {
      ...
      rows: [
        ...
        ["Cari konfirmasi sebulan lalu", "Kurang dari semenit", "Belasan menit, kadang tidak ketemu"],
        ["Siapa paham aturan tak tertulis grup", "Semua anggota tahu", "Cuma satu-dua orang senior yang “hafal”"],
        ["Kalau koordinator resign", "Serah terima lisan, tetap jalan", "Riwayat terputus, penerus meraba dari nol"],
        ["Membuktikan kesepakatan ke customer", "Tunjuk saja pesan yang relevan", "Screenshot terpotong, gampang diperdebatkan"],
      ],
    },
    {
      type: "h2",
      id: "yang-hilang-saat-orang-pergi",
      text: "Yang hilang begitu satu orang resign atau ganti HP",
    },
    {
      type: "p",
    ...
    {
      type: "quote",
      text: "Grup WhatsApp jarang gagal karena timnya malas mengetik. Ia gagal karena riwayat kerja bertahun-tahun cuma tersimpan di satu ponsel yang bisa hilang, rusak, atau berpindah tangan kapan saja.",
    },
    {
      type: "p",
